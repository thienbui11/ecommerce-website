...
public class CommonUtility {
	...
	public static void messageOutOfStock(String message, HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		forwardToPage("shop/out_of_stock.jsp", message, request, response);
	}
