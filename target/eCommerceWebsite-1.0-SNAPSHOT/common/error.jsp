...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6 align-self-center">
            ...
            <h2>${errorTitle}</h2>
            <p>${errorDetail}</p>
            <button onclick="goBack()" class="button-effect">Go back<i class="fal fa-long-arrow-left"></i></button>
        </div>
    </div>
</div>
    ...
    !function (t, e) {
        ...
        var qt, Yt = function _addPropTween(t, e, r, i, a, s, u, h, l) {
                ...
                var r, i, n, a, o, u, h, l, f, d, p, _, c, m = t.vars, g = m.ease, v = m.startAt, y = m.immediateRender,
                    T = m.lazy, b = m.onUpdate, w = m.onUpdateParams, x = m.callbackScope, k = m.runBackwards,
                    O = m.yoyoEase,
            ...
            Vt = (Ut + ",id,stagger,delay,duration,paused,scrollTrigger").split(","), Xt = function (S) {
                function Tween(t, e, i, n) {
                    ...
                    var o, h, l, f, d, _, c, m, g = (a = S.call(this, n ? e : ma(e), i) || this).vars, v = g.duration,
                        y = g.delay,
                        T = g.immediateRender, b = g.stagger, w = g.overwrite, x = g.keyframes, k = g.defaults,
                        C = g.scrollTrigger,
        ...
        var se, oe, ue, he, le, fe, de, pe, _e = Dt.Power0, ce = Dt.Power1, me = Dt.Power2, ge = Dt.Power3,
            ve = Dt.Power4,
            ...
            Ge = {
                ...
                var i, n, a, s, o, u, h, l, f, d, p, _, c, m, g, v, y, T, b, w, x, k, O, M, C, A, P, D, S, z, F, R,
                    E = t.style,
                ...
                var r = e || this, i = r.xPercent, n = r.yPercent, a = r.x, s = r.y, o = r.z, u = r.rotation,
                    h = r.rotationY,
                ...
                var r, i, n, a, s, o = e || this, u = o.xPercent, h = o.yPercent, l = o.x, f = o.y, d = o.rotation,
                    p = o.skewX,
